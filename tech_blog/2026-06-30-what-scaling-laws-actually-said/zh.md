...
secondary_keywords: ["Kaplan 2020 扩展定律", "Chinchilla 最优训练", "LLaMA 3 过度训练"]
...
![Kaplan、Chinchilla 与 LLaMA 3 的训练配方对比](images/fig1-training-regimes.png)
*不同的优化目标，导致截然不同的参数 / 数据配比决策。*
...
![预训练扩展 vs 推理时扩展的演进](images/fig2-scaling-axes.png)
*2020–2023 年预训练算力主导；2024 年起推理时算力成为独立的扩展轴。*
