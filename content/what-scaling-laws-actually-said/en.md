...
This axis isn't in the 2020 Kaplan framework. Whether the same smooth power-law extrapolation applies to inference-time compute is still an active research question.
